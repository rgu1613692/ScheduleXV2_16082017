//This class eveolve a population from one generation to the next using crossove, mutation and elitisim
package rug.ac.csdm.uk;
import java.util.ArrayList;
import java.util.stream.IntStream;
public class GeneticAlgorithm {
  private Data data;
  public GeneticAlgorithm(Data data) {this.data = data;} //contructor...
